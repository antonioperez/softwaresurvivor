...
tags: ['introduction', 'personal', 'programming', 'web-development', 'django', 'mezzanine']
draft: false
summary: 'Introduction to my programming blog and personal journey in software development, from TI-83 calculator programming to full-stack development.'
images: []
---
