    ...
    <div className="mx-auto max-w-2xl text-center">
      ...
      <form onSubmit={handleSubmit} className="mx-auto mt-8 flex max-w-md gap-x-4">
        ...
        <input
          ...
          className="focus:ring-brand-600 dark:focus:ring-brand-400 min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-gray-900 ring-1 shadow-sm ring-gray-300 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 dark:text-gray-100 dark:ring-gray-700"
