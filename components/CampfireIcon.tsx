...
const CampfireIcon: React.FC<CampfireIconProps> = ({ className = '', size = 'md' }) => {
  ...
  return (
    ...
    >
      ...
      <path d="M10 8c0-1.5 1-2.5 2.5-2.5 1.5 0 2.5 1 2.5 2.5 0 1-0.5 1.5-1 2 0.5 0.5 1 1 1 2 0 1.5-1 2.5-2.5 2.5-1.5 0-2.5-1-2.5-2.5 0-1 0.5-1.5 1-2-0.5-0.5-1-1-1-2z" fill="var(--color-campfire-400)"/>
    </svg>
  )
}
