            ...
            <div className="rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800">
              ...
              <form className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full rounded-md bg-blue-600 px-6 py-3 text-base font-medium text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none"
                  >
                    Send Message
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  {siteMetadata.linkedin && (
                    <Link
                      ...
                      className="flex items-center space-x-3 text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"
                      target="_blank"
